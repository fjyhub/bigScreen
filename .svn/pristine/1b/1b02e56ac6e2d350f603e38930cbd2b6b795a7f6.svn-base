...
<template>
  <div class="p22">
    <div class="flex" style="margin-bottom: 40px">
      ...
      <div style="font-size: 34px" class="linear-green">三大指数</div>
    </div>
    <div
      class="item relative"
    ...
    <div class="flex aline" style="margin-left: 250px;margin-top: -70px;"> 
      <span class="color1">2020</span>
