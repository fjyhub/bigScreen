...
<template>
  <div class="hudong">
    ...
    <div class="description">
      <span class="desc-title">互动资源占比</span>
      <span>
        <img
    ...
    padding: 0 20px;"
      ...
      <span class="desc-rate">{{ provinceGetData.resourceRate }}%</span>
    </div>
    <div class="res-item">
      <div class="res-item-left"><img :src="topList[0].img" alt="" /></div>
      <div class="res-item-right">
        <div class="res-item-info">
          <span class="title1">工商业用户</span>
          <span class="title2 linear-green">
            <span>{{ (provinceGetData.userCount / 10000).toFixed(2) }}</span>
            <span>户</span>
          </span>
          <span class="title3 linear-green">
            <span>{{ provinceGetData.userPower }}</span>
            <span>万千瓦</span>
          </span>
        </div>
        <div class="line"></div>
    ...
    <div class="res-item">
      ...
      <div class="res-item-right">
        <div class="res-item-info">
          <span class="title1">电动汽车</span>
          <span class="title2 linear-blue">
            <span>{{ (provinceGetData.electricCarCount / 10000).toFixed(2) }}</span>
            <span>万</span>
          </span>
          <span class="title3 linear-blue">
            <span>{{ provinceGetData.electricCarPower }}</span>
            <span>万kW</span>
          </span>
        </div>
    ...
    <div class="res-item">
      ...
      <div class="res-item-right">
        <div class="res-item-info">
          <span class="title1">通信基站</span>
          <span class="title2 linear-orange">
            <span>{{ (provinceGetData.baseStationCount / 10000).toFixed(2) }}</span>
            <span>万</span>
          </span>
          <span class="title3 linear-orange">
            <span>{{ provinceGetData.baseStationPower }}</span>
            <span>万kW</span>
          </span>
        </div>
        <div class="line thirth"></div>
      </div>
    </div>
    <div class="description">
    ...
    padding: 0 20px;"
      ...
      <span class="desc-rate">{{ provinceGetData.demandResponseRate }}%</span>
    </div>
    <div class="demand-item">
      <div class="demand-item-left"><img :src="bottomList[0].img" alt="" /></div>
      <div class="demand-item-right">
        <div class="demand-item-info">
          <span class="title1">响应用户数</span>
          <span class="title2" style="color:#f8fb1f;">
    ...
    <div class="demand-item">
      <div class="demand-item-left"><img :src="bottomList[1].img" alt="" /></div>
      <div class="demand-item-right">
        <div class="demand-item-info">
          <span class="title1">签约用户数</span>
          <span class="title2" style="color: #00ff72;">
