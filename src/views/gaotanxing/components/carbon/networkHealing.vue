  ...
  <div class="external_elec">
    ...
    <div class="inner_content">
      <div class="echarts_box">
        <img src="../../../../assets/carbon/healing_icon1.png" alt="" class="img_box">
        <div class="echart_dom" id="echart_dom7"></div>
      </div>
...
export default {
  ...
  methods: {
    initEcharts() {
      var myChart1 = Echarts.init(document.getElementById('echart_dom7'))
