  ...
  <div class="external_elec">
    ...
    <div class="inner_content clearfix">
      <div class="echart_pie">
        <div id="echarts_dom8" class="echart_dom"></div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    initEcharts() {
      this.myChart8 = Echarts.init(document.getElementById('echarts_dom8'))
      // 指定图表的配置项和数据
      var option = {
        grid: {
          left: '0',
      ...
      // 使用刚指定的配置项和数据显示图表。
      this.myChart8.setOption(option, true)
    }
  },
  beforeDestroy() {
    this.myChart8.clear() // 清空画布
    this.myChart8.dispose() // 释放实例
  }
}
</script>
